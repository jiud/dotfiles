(custom-set-variables
 ...
 '(package-selected-packages
   '(projectile ## crux all-the-icons-dired vscode-icon dired-sidebar lsp-python-ms lsp-java web-mode lsp-ui lsp-mode git-gutter doom-themes centaur-tabs doom-modeline one-themes highlight-indent-guides evil))
 '(tool-bar-mode nil))
(custom-set-faces
