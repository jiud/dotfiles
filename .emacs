(custom-set-variables
 ...
 '(package-selected-packages
   '(gruvbox-theme ranger danneskjold-theme bison-mode org-bullets bnf-mode undo-tree blackboard-theme subatomic-theme company magit vlf projectile ## crux all-the-icons-dired vscode-icon dired-sidebar lsp-python-ms lsp-java web-mode lsp-ui lsp-mode git-gutter doom-themes centaur-tabs doom-modeline one-themes evil))
...
(custom-set-faces
 ...
 '(all-the-icons-dcyan ((t (:foreground "gray"))))
 '(all-the-icons-dmaroon ((t (:foreground "olive drab"))))
 '(all-the-icons-dpink ((t (:foreground "orange"))))
 '(all-the-icons-dred ((t (:foreground "orange red"))))
 '(all-the-icons-maroon ((t (:foreground "orange"))))
 '(all-the-icons-red ((t (:foreground "orange red"))))
 '(bold ((t (:weight extra-bold))))
 '(centaur-tabs-active-bar-face ((t (:background "#b6e63e"))))
 '(centaur-tabs-default ((t (:background "#31363B" :foreground "dim gray"))))
 '(centaur-tabs-modified-marker-selected ((t (:inherit centaur-tabs-selected :foreground "dark orange"))))
 '(centaur-tabs-modified-marker-unselected ((t (:inherit centaur-tabs-unselected :foreground "orange red"))))
 '(centaur-tabs-unselected ((t (:background "#31363b" :foreground "#7984D1"))))
 '(centaur-tabs-unselected-modified ((t (:background "#31363b" :foreground "orange red"))))
...
(with-eval-after-load 'evil-maps
  ...
  ;;This makes space switch windows in normal mode only
  (define-key evil-normal-state-map " " 'other-window))

;;Keybindings for accesibility of resizing windows
...
;; Make whitespace visible, make 80 chars the limit of line length
(whitespace-mode 1)

;; Increase the line length standard by 2x on HTML, HBS, etc 
(add-hook 'web-mode-hook
          (lambda ()
            (setq-local whitespace-line-column 200)))

;;visible column numbers on modeline!
...
(defun notes ()
  "Go to uni agenda"
  (interactive)
  (find-file "~/uniBackup/TASKS/uniToDo.org"))

(defun books ()
  "Go to reading list"
  (interactive)
  (find-file "~/media/documents/reading-list.org"))
...
(defun web-search ()
  ...
  (interactive)
  (let ((question (read-string "Search Startpage.com: ")))
    (browse-url
...
;;Enabling ido-mode for better file finding
(ido-mode 1)
